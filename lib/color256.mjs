...
const hex2Idx = (hex, convert = false) => {
    ...
    if (convert) pList.push(hexIndexing);
    let idx = -1;
...
export { 
    idx2Hex, hex2Idx,
    hexTo256Color, rgbTo256Color,
    rgbIndexing, hexIndexing,
    getBackcolor, getForecolor, getColor
};
